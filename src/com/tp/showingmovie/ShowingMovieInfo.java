...
public class ShowingMovieInfo {
	...
	public ShowingMovieInfo() {
		// TODO Auto-generated constructor stub
	}

	public ShowingMovieInfo(BigDecimal sm_no, BigDecimal sm_mo_no, BigDecimal sm_th_no, BigDecimal sm_t_start,
			BigDecimal sm_t_end, BigDecimal mo_no, String mo_name, String mo_style, Date mo_release, String mo_director,
			String mo_actor, String mo_plot, BigDecimal mo_rating, String mo_img, BigDecimal mo_runningTime,
			BigDecimal t_no, BigDecimal t_theater_no, BigDecimal t_movie, String t_uid, String t_seat,
			BigDecimal t_price, BigDecimal t_start, BigDecimal t_end, BigDecimal th_no, String th_place,
			BigDecimal th_room, String th_seat) {
		super();
		this.sm_no = sm_no;
