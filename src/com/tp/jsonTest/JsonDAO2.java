...
public class JsonDAO2 {
	...
	public static void JsonMovie(HttpServletRequest request) {
		try {
		String url2 = "http://kobis.or.kr/kobisopenapi/webservice/rest/movie/searchMovieList.json?key=65d2f15dc3c548f84899d4172cd8912f&prdtStartYear=2010&prdtEndYear=2020";
		URL u2 = new URL(url2);
