...
$(function() {
	...
	$('#star_grade a').click(function() {
		...
		/* location.href = ReviewRegC?plot=$("#asdasd").val()&r_rating=$(this).attr("v") */
	...
	<input type="hidden" name="mo_no" value="${mo_no }">
                ...
                <div class="card-body">
                        ...
                        <div class="tab-pane fade show active" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                            <div class="form-group">
                               ...
                               <c:choose>
                                    ...
                                    <textarea name ="plot" class="form-control" id="asdasd" rows="3" placeholder="로그인 후 이용 가능합니다."></textarea>
                                    	</c:when>
                                    	<c:otherwise>
                                    <textarea name ="plot" class="form-control" id="asdasd" rows="3" placeholder="리뷰를  입력해주세요."></textarea>
                                    	</c:otherwise>
                                    </c:choose>
                            </div>
                    ...
                    <div class="btn-toolbar justify-content-between">
                        ...
                        <div class="btn-group">
                            <button type="submit" class="btn btn-primary1">후기 등록</button>
...
<jsp:include page="${showReviewPage}"></jsp:include>
